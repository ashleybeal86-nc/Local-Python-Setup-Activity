# Function 1: a function named hello() that prints a greeting to the user. This function should accept no arguments and returns nothing.

def hello():
    print("Hello User")


# Function 2: a function named pack() that accepts three arguments, and returns a single list with the three arguments inside as list elements.
...
hello()
print(pack("var1","var2","var3"))
print(pack(1,2,3))
eat_lunch([])
eat_lunch(["salad"])
eat_lunch(["smoothie","grapes","salad","brownie"])